...
class LSTM_point_process():
    
    def __init__(self, in_size, out_size, h_dim, n_layer, drop=0, num_layers = 2,
                 step = 2):
        self.model = LSTM_point_process.Model(in_size, out_size, 
    ...
    class Model(nn.Module):
        ...
        def __init__(self, input_size, output_size, hidden_dim, 
            ...
            super(LSTM_point_process.Model, self).__init__()
...
if __name__ == "__main__":
    ...
    mod = LSTM_point_process(in_size, out_size, h_dim=32, n_layer=3, drop = 0.1)
