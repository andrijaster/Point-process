...
class NF_point_process():
    
    def __init__(self, in_size, out_size, h_dim, n_layer, drop=0, num_layers = 2,
                 step = 2, step_z = 1.1):
        
        self.affine = NF_point_process.Affine_transform(in_size, step_z)
        
        inp_2 = int(in_size//step_z**2)
        self.flow = NF_point_process.Flow_transform(inp_2, out_size, 
    ...
    class Affine_transform(nn.Module):    
        ...
        def __init__(self, input_size, step_z):
            super(NF_point_process.Affine_transform, self).__init__()
    ...
    class Flow_transform(nn.Module):
        ...
        def __init__(self, input_size, output_size, hidden_dim, 
            ...
            super(NF_point_process.Flow_transform, self).__init__()
