# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 15:24:50 2019
...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 13:49:22 2019
...
class GRU:
    ...
    def build_lstm_graph_with_config(self):
        ...
        with self.lstm_graph.as_default():
            ...
            def _create_one_cell():
                lstm_cell = tf.contrib.rnn.GRUCell(self.lstm_size)
    ...
    def train_lstm_graph(self, train_X, train_Targets, interval):
        ...
        learning_rates_to_use = GRU._compute_learning_rates(self)
