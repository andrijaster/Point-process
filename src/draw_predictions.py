...
if __name__ == "__main__":
    ...
    data_folder = f"{project_dir}/data/autoput/prepared/"
    dataset_path = "stan1_traka1_7-17_04072017.csv"
    ...
    # model_filename = project_dir + '/models/geoloc/zh_main_station-240820-PoissonTPP-0.001-Euler.torch'
    # model_filename = project_dir + '/models/ski/ski-kg-2018-LSTMPointProcess-0.01-Euler.torch'
    model_filename = project_dir + '/models/autoput/autoput-040717-PoissonTPP-0.001-Euler.torch'
    ...
    print(f"ls: {1/expectation_of_lambda_per_second(train_list)}  , {predicted_lambdas.mean()}")
